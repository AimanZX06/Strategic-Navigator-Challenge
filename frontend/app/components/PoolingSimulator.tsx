  ...
  return (
    <div className="bg-white p-8 rounded-2xl shadow-xl border border-slate-100 mt-8">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-2xl text-slate-800 font-bold">Pooling Arbitrage Simulator</h2>
        {(shipA || shipB) && (
          <button
            onClick={handleReset}
      ...
      <div className="flex flex-col md:flex-row gap-8 mb-8">
        ...
        <div className="flex-1">
            <label 
              ...
              className="flex items-center gap-2 text-sm font-bold mb-3 text-red-600 uppercase"
            >
            ...
            <select 
              ...
              className="w-full p-4 text-base border-2 border-red-200 rounded-xl bg-red-50/50 focus:outline-none focus:ring-4 focus:ring-red-100 focus:border-red-400 text-slate-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all cursor-pointer font-medium"
            >
        ...
        <div className="flex-1">
            <label 
              ...
              className="flex items-center gap-2 text-sm font-bold mb-3 text-emerald-600 uppercase"
            >
            ...
            <select 
              ...
              className="w-full p-4 text-base border-2 border-emerald-200 rounded-xl bg-emerald-50/50 focus:outline-none focus:ring-4 focus:ring-emerald-100 focus:border-emerald-400 text-slate-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all cursor-pointer font-medium"
            >
